...
public class W3Schools_01 { //done

    /*
    Objective of the Code:
    The purpose of this Java program is to demonstrate various operations on ArrayLists,
    including adding elements, accessing elements, modifying elements, removing elements,
    clearing the ArrayList, and sorting the ArrayList in both ascending and descending order.
     */
    ...
    public static void main(String[] args) {
        ...
        // Reverse the sorted ArrayList using a for loop
        for (int i = myNumbers.size() - 1; i >= 0; i--) {
            // Add elements to the reversedNumbers list in reverse order
            reversedNumbers.add(myNumbers.get(i));
        }
